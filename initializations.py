...
def inidenity_initialization(shape: torch.Tensor) -> np.ndarray:
    """
...
def constant_initialization(shape: torch.Tensor, value: float) -> np.ndarray:
    """
...
def xaiver_initialization(shape: torch.Tensor) -> np.ndarray:
    """
...
def normalized_xaiver_initialization(shape: torch.Tensor) -> np.ndarray:
    """
    Xavier/Glorot initializer, with a uniform distribution scaled by
